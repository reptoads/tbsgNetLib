...
namespace ptl{
        ...
        /**
         * \brief calculates the needed ajustment for aligment
         ...
         * \return aligment adjustment (offset)
         */
        ...
        //Source: STD C++ Implemention of LLVM
		...
		template <typename T>
		inline size_t SizeOfContainerData(T container) //TODO SFINAE this
		{
